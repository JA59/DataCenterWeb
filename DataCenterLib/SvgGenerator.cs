...
namespace DataCenterLib
{
    public class SvgGenerator
    {
        ...
        public int AddExperimentMetaData(XElement experiment)
        {
            ...
            if (experiment.Attribute("Name") != null)
            {
            ...
            AppendText(150, y, 16, experiment.Attribute("UniqueElnId").Value, "fill:darkgreen"); y = y + 20;
            AppendText(0, y, 16, "Name:", "");
            AppendText(150, y, 16, name, "fill:darkgreen"); y = y + 20;
            AppendText(0, y, 16, "Tracking ID:", "");
            AppendText(150, y, 16, experiment.Attribute("TrackingId").Value, "fill:darkgreen"); y = y + 20;
            AppendText(0, y, 16, "User:", "");
            AppendText(150, y, 16, experiment.Attribute("User").Value, "fill:darkgreen"); y = y + 20;
            AppendText(0, y, 16, "Project:", "");
            AppendText(150, y, 16, experiment.Attribute("Project").Value, "fill:darkgreen"); y = y + 20;
